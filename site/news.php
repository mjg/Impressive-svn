...
<p>Other than that, there are not much changes: The Win32 package is now built with Python 3 too, and for 64-bit architectures. The page count for the <code>--page-progress</code> option can now be limited (to compensate for backup slides, for example), the overview animation time can be configured independently from the zoom animation time, and if more than one progress bar can now be displayed at once.</p>
